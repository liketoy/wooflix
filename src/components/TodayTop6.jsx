...
function TodayTop6() {
    ...
    useEffect(() => {
        fetch("https://api.themoviedb.org/3/movie/popular?api_key=69dc528378613ffdddf3bf5f1b554971&language=ko-KR&page=1&region=kr")
